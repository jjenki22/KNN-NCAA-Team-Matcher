ui <- (
  fluidPage(
    ...
    fluidRow(
      column(4, 
             tags$img(src="ncaa logo.jpg", height=160)),
      column(4,
             fluidRow(h1(strong("NCAA Team Matcher"), style = "font-size:55px"))),
      column(4,
             tags$img(src="ncaa-logo-Floor.jpg", height=160))),
    navbarPage("",
               tabPanel("Graphs",
                        sidebarLayout(
